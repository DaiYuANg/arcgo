...
func (a *Adapter) XPendingRange(_ context.Context, _, _, _, _ string, _ int64) ([]kvx.PendingEntry, error) {
	return nil, errValkeyUnsupported("XPendingRange")
}

// XClaim claims pending entries for a consumer.
func (a *Adapter) XClaim(_ context.Context, _, _, _ string, _ time.Duration, _ []string) ([]kvx.StreamEntry, error) {
	return nil, errValkeyUnsupported("XClaim")
}

// XAutoClaim auto-claims pending entries.
func (a *Adapter) XAutoClaim(_ context.Context, _, _, _ string, _ time.Duration, _ string, _ int64) (string, []kvx.StreamEntry, error) {
	return "", nil, errValkeyUnsupported("XAutoClaim")
}

// XInfoGroups gets info about consumer groups.
func (a *Adapter) XInfoGroups(_ context.Context, _ string) ([]kvx.GroupInfo, error) {
	return nil, errValkeyUnsupported("XInfoGroups")
}

// XInfoConsumers gets info about consumers in a group.
func (a *Adapter) XInfoConsumers(_ context.Context, _, _ string) ([]kvx.ConsumerInfo, error) {
